...
public class MicroOperacionesEmpresarialApplication extends  AbstractReactiveMongoConfiguration  {
	...
	private String db;
	 @Bean
		...
		public static final ApiInfo DEFAULT_API_INFO = new ApiInfo("Documentation MICRO-OPERACIONES-EMPRESARIAL API", "Documentation MICRO-OPERACIONES-PERSONAL API", "1.0",
